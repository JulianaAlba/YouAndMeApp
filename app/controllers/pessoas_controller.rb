class PessoasController < ApplicationController
  ...
  private
    ...
    def pessoa_params
      params.require(:pessoa).permit(:nome, :idade, :senha, :confirmarsenha, :sexo, :sexoparceiro, :qualidade_id, :qualidadeparceiro_id, :defeito_id, :defeitoparceiro_id, :picture_id)
    end
end
